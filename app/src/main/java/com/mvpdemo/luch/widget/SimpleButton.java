...
import com.mvpdemo.luch.utils.MeasureUtils;
...
public class SimpleButton extends View {
    ...
    private void _init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            try {
                mTagShape = a.getInteger(R.styleable.SimpleButton_sb_shape,
                        SimpleButton.SHAPE_ROUND_RECT);
                mTagMode = a.getInteger(R.styleable.SimpleButton_sb_mode, MODE_NORMAL);
                if (mTagMode == MODE_CHECK || mTagMode == MODE_ICON_CHECK_INVISIBLE
                ...
                mIsAutoToggleCheck = a.getBoolean(R.styleable.SimpleButton_sb_auto_check,
                        mIsAutoToggleCheck);
                ...
                mBorderColor = a.getColor(R.styleable.SimpleButton_sb_border_color,
                        Color.parseColor("#ff333333"));
                mTextColor = a.getColor(R.styleable.SimpleButton_sb_text_color,
                        Color.parseColor("#ff666666"));
                mBgColorChecked = a.getColor(R.styleable.SimpleButton_sb_bg_color_check, mBgColor);
                mBorderColorChecked = a.getColor(R.styleable.SimpleButton_sb_border_color_check,
                        mBorderColor);
                mTextColorChecked = a.getColor(R.styleable.SimpleButton_sb_text_color_check,
                        mTextColor);
                mBorderWidth = a.getDimension(R.styleable.SimpleButton_sb_border_width,
                        mBorderWidth);
                mRadius = a.getDimension(R.styleable.SimpleButton_sb_border_radius, mRadius);
                mHorizontalPadding = (int) a.getDimension(
                        R.styleable.SimpleButton_sb_horizontal_padding, mHorizontalPadding);
                mVerticalPadding = (int) a.getDimension(
                        R.styleable.SimpleButton_sb_vertical_padding, mVerticalPadding);
                mIconPadding = (int) a.getDimension(R.styleable.SimpleButton_sb_icon_padding,
                        mIconPadding);
        ...
        if (mTagMode == MODE_ICON_CHECK_CHANGE && mDecorateIconChange == null) {
            throw new RuntimeException(
                    "You must set the drawable by 'tag_icon_change' property in "
    ...
    private int _adjustText(int maxWidth) {
        if (mPaint.getTextSize() != mTextSize) {
            ...
            mBaseLineDistance = (int) Math.ceil(
